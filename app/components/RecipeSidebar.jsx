...
export default function RecipeSidebar({ filters, setFilters }) {
  ...
  return (
    <>
      ...
      <div className={`lg:w-64 w-full bg-white shadow-lg p-4 lg:p-6 lg:h-screen lg:overflow-y-auto lg:fixed fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-200 ease-in-out z-40`}>
