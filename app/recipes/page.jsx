  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col md:flex-row pt-16 min-h-screen">
        ...
        <div className={`fixed md:relative md:sticky top-0 h-screen w-64 bg-gray-100 shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out z-50`}>
